...
const employees: Emp[] = [
  ...
  { ...emp('dev-admin-001', '青木 由奈', 'yuna.aoki.web@gmail.com',
    ...
    projects: [P.SAAS_RENEWAL, P.AI_PROJECT],
    selfIntroduction: 'フロントエンドエンジニアとしてプロダクト開発に携わりながら、システム管理も担当しています。使いやすいUIとシンプルな設計を大切にしています。',
    strengths: 'React / TypeScript でのコンポーネント設計と状態管理。Firebase を活用した迅速なプロトタイピング。',
    growthSkills: 'バックエンドの深堀り（Go）、チームリード',
    interests: 'フロントエンド技術全般、デザインシステム、開発者体験（DX）向上',
    hobbies: 'カフェでコーディング、アニメ鑑賞、散歩',
    personalMessage: 'いいプロダクトは、いいチームから生まれます。',
    workLocation: '週3出社、週2リモート',
    availability: 'フルタイム',
    careerHistory: 'フリーランス Web エンジニア（2年）→ 当社',
    certifications: 'Firebase 認定資格（取得中）' },
  ...
  { ...emp('dev-dev-001', '田中 太郎', 'tanaka@example.com',
    ...
    selfIntroduction: 'バックエンドエンジニアとしてキャリアをスタートし、現在は開発部の部長としてチーム全体の技術リードを担っています。コードの品質とチームの成長を両立させることを大切にしています。',
  ...
  { ...emp('dev-dev-002', '鈴木 花子', 'suzuki@example.com',
    ...
    selfIntroduction: 'ユーザーが「使いやすい」と感じる瞬間をつくるのが好きです。デザインとエンジニアリングの橋渡し役として、チームの中で価値を発揮しています。',
  ...
  { ...emp('dev-dev-003', '佐藤 健', 'sato@example.com',
    ...
    selfIntroduction: 'React と TypeScript を中心に、ユーザーに届くプロダクトを作るのが好きです。パフォーマンスとコードの読みやすさを大切にしています。',
  ...
  { ...emp('dev-dev-004', '高橋 美咲', 'takahashi@example.com',
    ...
    selfIntroduction: '新卒でエンジニアになり3年目。まだまだ学ぶことが多いですが、毎日楽しくコードを書いています！デザインとエンジニアリングの両方に興味があります。',
  ...
  { ...emp('dev-dev-005', '伊藤 大輔', 'ito@example.com',
    ...
    selfIntroduction: 'バックエンドとデータ基盤の設計が専門です。パフォーマンスとスケーラビリティを意識した設計で、プロダクトの成長を支えています。',
  ...
  { ...emp('dev-dev-006', '渡辺 さくら', 'watanabe@example.com',
    ...
    selfIntroduction: 'データを通じてビジネスの課題を発見し、解決策を提案するのが好きです。エンジニアとしてだけでなく、データアナリストとしての視点も大切にしています。',
    ...
    workLocation: 'フルリモート',
    availability: 'フルタイム',
    careerHistory: 'データアナリスト（コンサル・2年）→ データエンジニア（スタートアップ・2年）→ 当社',
  ...
  { ...emp('dev-dev-008', '中村 麻衣', 'nakamura@example.com',
    ...
    selfIntroduction: 'クラウドインフラの設計・構築・運用を担当しています。「止まらないシステム」を作ることにやりがいを感じています。',
  ...
  { ...emp('dev-hr-002', '山田 彩', 'yamada@example.com',
    ...
    selfIntroduction: '「いい人に会いたい」ではなく「いいマッチングをしたい」が採用のモットー。候補者にも会社にも誠実でいることを大切にしています。',
  ...
  { ...emp('dev-sales-001', '木村 奈々', 'kimura@example.com',
    ...
    selfIntroduction: '数字で語り、人で動かすのが営業の醍醐味だと思っています。チームが成果を出せる仕組みづくりと、個々のメンバーの成長支援を大切にしています。',
  ...
  { ...emp('dev-sales-002', '林 雄介', 'hayashi@example.com',
    ...
    selfIntroduction: '既存顧客との長期的な信頼関係づくりが得意です。「また林さんに頼みたい」と言ってもらえることが一番のモチベーションです。',
  ...
  { ...emp('dev-ga-001', '阿部 葵', 'abe@example.com',
    ...
    selfIntroduction: '「縁の下の力持ち」として、会社の土台を支える仕事にやりがいを感じています。法務・経理・施設管理まで幅広く担い、社員が安心して働ける環境を整えています。',
  ...
  { ...emp('dev-mkt-001', '後藤 理沙', 'goto@example.com',
    ...
    selfIntroduction: 'ブランドと顧客の接点をデザインするのがマーケターの仕事だと思っています。データと感性の両方を使ってメッセージを届けることを大切にしています。',
  ...
  { ...emp('dev-cs-001', '村田 剛', 'murata@example.com',
    ...
    selfIntroduction: 'お客様の声こそがプロダクト改善のヒントだと信じています。サポートチームが会社の最前線として誇りを持って働けるよう、環境整備に取り組んでいます。',
